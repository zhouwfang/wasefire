...
cargo check --target=riscv32imc-unknown-none-elf --features=target-riscv,runtime-base
# error: unknown target triple 'riscv32imc-unknown-none-elf', please use -triple or -arch
# cargo check --target=riscv32imc-unknown-none-elf --features=target-riscv,runtime-wasm3
